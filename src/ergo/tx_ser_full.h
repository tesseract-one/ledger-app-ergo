...
typedef enum {
    ...
    ERGO_TX_SERIALIZER_FULL_RES_ERR_BAD_PROOF_SIZE = 0x03,
    ...
    ERGO_TX_SERIALIZER_FULL_RES_ERR_TOO_MANY_TOKENS = 0x10,
    ERGO_TX_SERIALIZER_FULL_RES_ERR_TOO_MANY_INPUTS = 0x11,
    ERGO_TX_SERIALIZER_FULL_RES_ERR_TOO_MANY_DATA_INPUTS = 0x12,
    ERGO_TX_SERIALIZER_FULL_RES_ERR_TOO_MANY_INPUT_FRAMES = 0x13,
    ERGO_TX_SERIALIZER_FULL_RES_ERR_TOO_MANY_OUTPUTS = 0x14,
    ERGO_TX_SERIALIZER_FULL_RES_ERR_TOO_MANY_REGISTERS = 0x15,
    ERGO_TX_SERIALIZER_FULL_RES_ERR_TOO_MUCH_DATA = 0x16,
    ERGO_TX_SERIALIZER_FULL_RES_ERR_U64_OVERFLOW = 0x17,
    ERGO_TX_SERIALIZER_FULL_RES_ERR_HASHER = 0x18,
    ERGO_TX_SERIALIZER_FULL_RES_ERR_BUFFER = 0x19,
    ERGO_TX_SERIALIZER_FULL_RES_ERR_BAD_STATE = 0x20
