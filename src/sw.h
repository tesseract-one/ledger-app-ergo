...
#define SW_BAD_TRANSACTION_PREFIX_LEN 0xE017
#define SW_BAD_TRANSACTION_SUFFIX_LEN 0xE018
#define SW_SCHNORR_SIGNING_FAILED     0xE019
#define SW_BAD_FRAME_SIGNATURE        0xE01A
