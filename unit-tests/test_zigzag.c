...
static void test_zigzag_encode_i32_zero(void **state) {
    ...
    int32_t val = 0;
    assert_int_equal(zigzag_encode_i32(val), 0);
}
...
static void test_zigzag_encode_i32_minus_one(void **state) {
    ...
    int32_t val = -1;
    assert_int_equal(zigzag_encode_i32(val), 1);
}
...
static void test_zigzag_encode_i32_one(void **state) {
    ...
    int32_t val = 1;
    assert_int_equal(zigzag_encode_i32(val), 2);
}
...
static void test_zigzag_encode_i32(void **state) {
    ...
    int32_t val = -123456;
    assert_int_equal(zigzag_encode_i32(val), 246911);
}
...
static void test_zigzag_encode_i32_min(void **state) {
    ...
    assert_int_equal(zigzag_encode_i32(val), 4294967295);
}
...
static void test_zigzag_encode_i32_max(void **state) {
    ...
    assert_int_equal(zigzag_encode_i32(val), 4294967294);
}
...
static void test_zigzag_encode_i64_zero(void **state) {
    ...
    int64_t val = 0;
    assert_int_equal(zigzag_encode_i64(val), 0);
}
...
static void test_zigzag_encode_i64_minus_one(void **state) {
    ...
    int64_t val = -1;
    assert_int_equal(zigzag_encode_i64(val), 1);
}
...
static void test_zigzag_encode_i64_one(void **state) {
    ...
    int64_t val = 1;
    assert_int_equal(zigzag_encode_i64(val), 2);
}
...
static void test_zigzag_encode_i64(void **state) {
    ...
    assert_int_equal(zigzag_encode_i64(val), 24691357801);
}
...
static void test_zigzag_encode_i64_min(void **state) {
    ...
    assert_int_equal(zigzag_encode_i64(val), 18446744073709551615ull);
}
...
static void test_zigzag_encode_i64_max(void **state) {
    ...
    assert_int_equal(zigzag_encode_i64(val), 18446744073709551614ull);
}
...
static void test_zigzag_decode_i32(void **state) {
    ...
    assert_int_equal(result, -123456);
}
...
static void test_zigzag_decode_i64(void **state) {
    ...
    assert_int_equal(result, -12345678901);
}
...
static void test_zigzag_decode_i64_min(void **state) {
    ...
    assert_int_equal(result, INT64_MIN);
}
...
static void test_zigzag_decode_i64_max(void **state) {
    ...
    assert_int_equal(result, INT64_MAX);
}
