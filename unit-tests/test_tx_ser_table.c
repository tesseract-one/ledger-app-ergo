...
static void test_ergo_tx_serializer_table_add(void **state) {
    ...
    assert_memory_equal(context.tokens_table, &expected_tokens_table, sizeof(expected_tokens_table));
}
...
int main() {
    const struct CMUnitTest tests[] = {cmocka_unit_test(test_ergo_tx_serializer_table_init),
