...
static void test_ergo_tx_serializer_full_init(void** state) {
    ...
    assert_memory_equal(context.tokens_table, &tokens_table, sizeof(tokens_table));
    assert_int_equal(context.table_ctx.tokens_count, tokens_count);
    assert_memory_equal(context.table_ctx.tokens_table, &tokens_table, sizeof(tokens_table));
...
static void test_ergo_tx_serializer_full_add_input(void** state) {
    ...
    assert_int_equal(
        ergo_tx_serializer_full_add_input(
            &context,
            box_id,
            token_frames_count,
...
static void test_ergo_tx_serializer_full_add_input_tokens(void** state) {
    ...
    BUFFER_FROM_ARRAY_FULL(input_tokens, input_tokens_array, sizeof(input_tokens_array));
    assert_int_equal(
...
static void test_ergo_tx_serializer_full_add_input_context_extension(void** state) {
    ...
    BUFFER_FROM_ARRAY_FULL(input_tokens, input_tokens_array, sizeof(input_tokens_array));
    ergo_tx_serializer_full_add_input_tokens(&context, box_id, token_frame_index, &input_tokens);
    uint8_t extension_chunk_array[2] = {
        0x01, 0x02
    };
    BUFFER_FROM_ARRAY_FULL(extension_chunk, extension_chunk_array, sizeof(extension_chunk_array));
    assert_int_equal(
...
static void test_ergo_tx_serializer_full_add_data_inputs(void** state) {
    ...
    BUFFER_FROM_ARRAY_FULL(extension_chunk, extension_chunk_array, sizeof(extension_chunk_array));
    ergo_tx_serializer_full_add_input_context_extension(&context, &extension_chunk);
    uint8_t inputs_array[32] = {
        0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05,
        0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05,
        0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05,
        0x05, 0x05
    };
    BUFFER_FROM_ARRAY_FULL(inputs, inputs_array, sizeof(inputs_array));
    assert_int_equal(
...
static void test_ergo_tx_serializer_full_add_box_change_tree(void** state) {
    ...
    assert_int_equal(
        ergo_tx_serializer_full_add_box_change_tree(&context, raw_pub_key),
        ERGO_TX_SERIALIZER_FULL_RES_OK
    );
}
...
static void test_ergo_tx_serializer_full_add_box_miners_fee_tree(void** state) {
    ...
    assert_int_equal(
        ergo_tx_serializer_full_add_box_miners_fee_tree(&context, is_mainnet),
        ERGO_TX_SERIALIZER_FULL_RES_OK
    );
}
...
static void test_ergo_tx_serializer_full_add_box_tokens(void** state) {
    ...
    BUFFER_FROM_ARRAY_FULL(box_tokens, box_tokens_array, sizeof(box_tokens_array));
    assert_int_equal(
...
static void test_ergo_tx_serializer_full_add_box_registers(void** state) {
    ...
    BUFFER_FROM_ARRAY_FULL(box_tokens, box_tokens_array, sizeof(box_tokens_array));
    ergo_tx_serializer_full_add_box_tokens(&context, &box_tokens);
    uint8_t registers_chunk_array[1] = {
        0x01
    };
    BUFFER_FROM_ARRAY_FULL(registers_chunk, registers_chunk_array, sizeof(registers_chunk_array));
    assert_int_equal(
        ergo_tx_serializer_full_add_box_registers(&context, &registers_chunk),
        ERGO_TX_SERIALIZER_FULL_RES_OK
    );
}
