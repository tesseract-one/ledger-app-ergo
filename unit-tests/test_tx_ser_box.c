...
static void test_ergo_tx_serializer_box_add_tree(void **state) {
    ...
    uint8_t expected_hash[6] = {
        0xb9, 0x60, 0x01, 0x02, 0x03, 0x02
    };
    VERIFY_HASH(context.hash, expected_hash);
    assert_int_equal(context.type, ERGO_TX_SERIALIZER_BOX_TYPE_TREE);
...
static void test_ergo_tx_serializer_box_add_miners_fee_tree_mainnet(void **state) {
    ...
    uint8_t expected_hash[109] = {
        0xb9, 0x60, 0x10, 0x05, 0x04, 0x00, 0x04, 0x00, 0x0e, 0x36,
        0x10, 0x02, 0x04, 0xa0, 0x0b, 0x08, 0xcd, 0x02, 0x79, 0xbe,
        0x66, 0x7e, 0xf9, 0xdc, 0xbb, 0xac, 0x55, 0xa0, 0x62, 0x95,
        0xce, 0x87, 0x0b, 0x07, 0x02, 0x9b, 0xfc, 0xdb, 0x2d, 0xce,
        0x28, 0xd9, 0x59, 0xf2, 0x81, 0x5b, 0x16, 0xf8, 0x17, 0x98,
        0xea, 0x02, 0xd1, 0x92, 0xa3, 0x9a, 0x8c, 0xc7, 0xa7, 0x01,
        0x73, 0x00, 0x73, 0x01, 0x10, 0x01, 0x02, 0x04, 0x02, 0xd1,
        0x96, 0x83, 0x03, 0x01, 0x93, 0xa3, 0x8c, 0xc7, 0xb2, 0xa5,
        0x73, 0x00, 0x00, 0x01, 0x93, 0xc2, 0xb2, 0xa5, 0x73, 0x01,
        0x00, 0x74, 0x73, 0x02, 0x73, 0x03, 0x83, 0x01, 0x08, 0xcd,
        0xee, 0xac, 0x93, 0xb1, 0xa5, 0x73, 0x04, 0x03, 0x02
    };
    VERIFY_HASH(context.hash, expected_hash);
...
static void test_ergo_tx_serializer_box_add_miners_fee_tree_testnet(void **state) {
    ...
    uint8_t expected_hash[109] = {
        0xb9, 0x60, 0x10, 0x05, 0x04, 0x00, 0x04, 0x00, 0x0e, 0x36,
        0x10, 0x02, 0x04, 0x90, 0x01, 0x08, 0xcd, 0x02, 0x79, 0xbe,
        0x66, 0x7e, 0xf9, 0xdc, 0xbb, 0xac, 0x55, 0xa0, 0x62, 0x95,
        0xce, 0x87, 0x0b, 0x07, 0x02, 0x9b, 0xfc, 0xdb, 0x2d, 0xce,
        0x28, 0xd9, 0x59, 0xf2, 0x81, 0x5b, 0x16, 0xf8, 0x17, 0x98,
        0xea, 0x02, 0xd1, 0x92, 0xa3, 0x9a, 0x8c, 0xc7, 0xa7, 0x01,
...
static void test_ergo_tx_serializer_box_add_change_tree(void **state) {
    ...
    uint8_t expected_hash[40] = {
        0xb9, 0x60, 0x00, 0x08, 0xcd, 0x03, 0x8b, 0x9f, 0xf8, 0x5d,
...
static void test_ergo_tx_serializer_box_add_tokens(void **state) {
    ...
    uint8_t expected_hash[26] = {
        0xb9, 0x60, 0x01, 0x02, 0x03, 0x02, 0x00, 0x81, 0x82, 0x84,
        0x88, 0x90, 0xa0, 0xc0, 0x80, 0x01, 0x01, 0x82, 0x84, 0x88,
        0x90, 0xa0, 0xc0, 0x80, 0x81, 0x02
    };
    VERIFY_HASH(context.hash, expected_hash);
...
static void test_ergo_tx_serializer_box_id_hash(void **state) {
    ...
    uint8_t expected_box_id[ERGO_ID_LEN] = {
        0xf1, 0xca, 0x1e, 0x06, 0x0a, 0xa1, 0x1f, 0x98, 0x9b, 0x3d,
        0x70, 0xec, 0x0e, 0x0c, 0x98, 0x7c, 0x95, 0x2e, 0x23, 0x89,
        0xbe, 0x5b, 0x82, 0x0b, 0xc7, 0xdb, 0xfc, 0x32, 0x6f, 0x86,
        0x13, 0x73
    };
    assert_memory_equal(box_id, expected_box_id, ERGO_ID_LEN);
    uint8_t expected_hash[61] = {
        0xb9, 0x60, 0x01, 0x02, 0x03, 0x02, 0x00, 0x81, 0x82, 0x84,
        0x88, 0x90, 0xa0, 0xc0, 0x80, 0x01, 0x01, 0x82, 0x84, 0x88,
        0x90, 0xa0, 0xc0, 0x80, 0x81, 0x02, 0x01, 0x02, 0x01, 0x01,
        0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
        0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
        0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
        0x01
